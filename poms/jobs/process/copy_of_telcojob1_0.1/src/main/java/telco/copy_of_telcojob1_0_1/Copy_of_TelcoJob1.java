...
package telco.copy_of_telcojob1_0_1;
...
/**
 * Job: Copy_of_TelcoJob1 Purpose: <br>
 * Description: <br>
 * 
 ...
 * @status
 */
public class Copy_of_TelcoJob1 implements TalendJob {
	static {
		System.setProperty("TalendJob.log", "Copy_of_TelcoJob1.log");
	}

	private static org.apache.logging.log4j.Logger log = org.apache.logging.log4j.LogManager
			.getLogger(Copy_of_TelcoJob1.class);
	...
	private final String jobName = "Copy_of_TelcoJob1";
	...
	private class TalendException extends Exception {
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TalendException)) {
				Copy_of_TelcoJob1.this.exception = e;
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(Copy_of_TelcoJob1.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public static class row5Struct implements routines.system.IPersistableComparableLookupRow<row5Struct> {
		final static byte[] commonByteArrayLock_TELCO_Copy_of_TelcoJob1 = new byte[0];
		static byte[] commonByteArray_TELCO_Copy_of_TelcoJob1 = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_TELCO_Copy_of_TelcoJob1.length) {
					if (length < 1024 && commonByteArray_TELCO_Copy_of_TelcoJob1.length == 0) {
						commonByteArray_TELCO_Copy_of_TelcoJob1 = new byte[1024];
					} else {
						commonByteArray_TELCO_Copy_of_TelcoJob1 = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_TELCO_Copy_of_TelcoJob1, 0, length);
				strReturn = new String(commonByteArray_TELCO_Copy_of_TelcoJob1, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException {
			...
			if (length == -1) {
				...
				unmarshaller.readFully(commonByteArray_TELCO_Copy_of_TelcoJob1, 0, length);
				strReturn = new String(commonByteArray_TELCO_Copy_of_TelcoJob1, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readKeysData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_TELCO_Copy_of_TelcoJob1) {
	...
	public void tFileInputDelimited_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		mdc("tFileInputDelimited_1", "ZvmHNa_");
...
// ------------
					...
					class BytesLimit65535_tFileInputDelimited_1 {
						public void limitLog4jByte() throws Exception {
							...
							log4jParamters_tFileInputDelimited_1.append("FILENAME" + " = "
									+ "\"/Users/abuzaki/Desktop/LAB/Transaction Data - RapidMiner Data.csv\"");
							log4jParamters_tFileInputDelimited_1.append(" | ");
				...
				if (enableLogStash) {
					talendJobLog.addCM("tFileInputDelimited_1", "TransactionData", "tFileInputDelimited");
					talendJobLogProcess(globalMap);
					s(currentComponent);
				}
				...
				try {
					...
					Object filename_tFileInputDelimited_1 = "/Users/abuzaki/Desktop/LAB/Transaction Data - RapidMiner Data.csv";
					...
					try {
						fid_tFileInputDelimited_1 = new org.talend.fileprocess.FileInputDelimited(
								"/Users/abuzaki/Desktop/LAB/Transaction Data - RapidMiner Data.csv", "UTF-8", ",", "\n",
					...
					while (fid_tFileInputDelimited_1 != null && fid_tFileInputDelimited_1.nextRecord()) {
						...
						try {
							...
							row4.CustomerId = fid_tFileInputDelimited_1.get(columnIndexWithD_tFileInputDelimited_1)
									.trim();
							...
							if (temp.length() > 0) {
								...
								try {
									...
									row4.TransactionValue = ParserUtils.parseTo_Double(temp);
									...
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format(
											...
											"TransactionValue", "row4", temp, ex_tFileInputDelimited_1),
							...
							row4.PaymentMethod = fid_tFileInputDelimited_1.get(columnIndexWithD_tFileInputDelimited_1)
									.trim();
							...
							if (temp.length() > 0) {
								...
								try {
									...
									row4.Date = ParserUtils.parseTo_Date(temp, "yyyy-dd-MM HH:mm:ss");
									...
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"Date", "row4", temp, ex_tFileInputDelimited_1), ex_tFileInputDelimited_1));
								}
...
// Start of branch "row4"
						if (row4 != null) {
							...
							if (runStat.update(execStat, enableLogStash, iterateId, 1, 1
									...
									, "row4", "tFileInputDelimited_1", "TransactionData", "tFileInputDelimited",
							...
							operation_finder_tAggregateRow_1.CustomerId = row4.CustomerId;
							...
							if (operation_result_tAggregateRow_1.TotalTransaction_sum == null) {
								operation_result_tAggregateRow_1.TotalTransaction_sum = new BigDecimal(0).setScale(0);
							}
							operation_result_tAggregateRow_1.TotalTransaction_sum = operation_result_tAggregateRow_1.TotalTransaction_sum
									.add(new BigDecimal(String.valueOf(row4.TransactionValue)));
					...
					if (!((Object) ("/Users/abuzaki/Desktop/LAB/Transaction Data - RapidMiner Data.csv") instanceof java.io.InputStream)) {
				...
				if (runStat.updateStatAndLog(execStat, enableLogStash, resourceMap, iterateId, "row4", 2, 0,
						"tFileInputDelimited_1", "TransactionData", "tFileInputDelimited", "tAggregateRow_1_AGGOUT",
				...
				// source node:tAggregateRow_1_AGGIN - inputs:(OnRowsEnd) outputs:(row5,row5) |
				// target node:tAdvancedHash_row5 - inputs:(row5) outputs:()
				// linked node: tMap_1 - inputs:(row5,row3,row2,row12,row1)
				...
				for (AggOperationStruct_tAggregateRow_1 aggregated_row_tAggregateRow_1 : values_tAggregateRow_1) { // G_AggR_600
					...
					if (aggregated_row_tAggregateRow_1.TotalTransaction_sum != null) {
						row5.TotalTransaction = aggregated_row_tAggregateRow_1.TotalTransaction_sum.doubleValue();
					...
					if (runStat.update(execStat, enableLogStash, iterateId, 1, 1
							...
							, "row5", "tAggregateRow_1_AGGIN", "tAggregateRow_1_AGGIN", "tAggregateIn",
							"tAdvancedHash_row5", "tAdvancedHash_row5", "tAdvancedHash"
					...
					row5_HashRow.TotalTransaction = row5.TotalTransaction;
				...
				if (runStat.updateStatAndLog(execStat, enableLogStash, resourceMap, iterateId, "row5", 2, 0,
						"tAggregateRow_1_AGGIN", "tAggregateRow_1_AGGIN", "tAggregateIn", "tAdvancedHash_row5",
	...
	public void tFileInputDelimited_2Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		mdc("tFileInputDelimited_2", "1g1GbB_");
...
// Start of branch "row3"
	...
	public void tFileInputDelimited_3Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		mdc("tFileInputDelimited_3", "27cKko_");
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				if (enableLogStash) {
					talendJobLog.addCM("tFileInputDelimited_3", "tFileInputDelimited_1", "tFileInputDelimited");
					talendJobLogProcess(globalMap);
					s(currentComponent);
				}
...
// Start of branch "row2"
						if (row2 != null) {
							...
							if (runStat.update(execStat, enableLogStash, iterateId, 1, 1
									...
									, "row2", "tFileInputDelimited_3", "tFileInputDelimited_1", "tFileInputDelimited",
				...
				if (runStat.updateStatAndLog(execStat, enableLogStash, resourceMap, iterateId, "row2", 2, 0,
						"tFileInputDelimited_3", "tFileInputDelimited_1", "tFileInputDelimited", "tAdvancedHash_row2",
	...
	public void tFileInputDelimited_4Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		mdc("tFileInputDelimited_4", "E2QV8M_");
						...
						public void limitLog4jByte() throws Exception {
							...
							log4jParamters_tFileInputDelimited_4.append(
									"TRIMSELECT" + " = " + "[{TRIM=" + ("false") + ", SCHEMA_COLUMN=" + ("CustomerId")
											+ "}, {TRIM=" + ("false") + ", SCHEMA_COLUMN=" + ("DateChurn") + "}]");
							log4jParamters_tFileInputDelimited_4.append(" | ");
...
///////////////////////    			
				...
				if (log.isDebugEnabled()) {
					class BytesLimit65535_tFileOutputDelimited_3 {
						public void limitLog4jByte() throws Exception {
							...
							log4jParamters_tFileOutputDelimited_3.append(" | ");
							log4jParamters_tFileOutputDelimited_3.append("INCLUDEHEADER" + " = " + "false");
							log4jParamters_tFileOutputDelimited_3.append(" | ");
				...
				if (enableLogStash) {
					talendJobLog.addCM("tFilterRow_14", "tFilterRow_1", "tFilterRow");
					talendJobLogProcess(globalMap);
					s(currentComponent);
				}
				...
				if (enableLogStash) {
					talendJobLog.addCM("tFilterRow_10", "tFilterRow_1", "tFilterRow");
					talendJobLogProcess(globalMap);
					s(currentComponent);
				}
...
// ###############################
					...
					class BytesLimit65535_tFileInputExcel_1 {
						public void limitLog4jByte() throws Exception {
							...
							log4jParamters_tFileInputExcel_1.append("PASSWORD" + " = "
									+ String.valueOf(
											"enc:routine.encryption.key.v1:r5I9moCOSJH1j8w0r36tSmI3xNFS4kU6DK1/Xw==")
											.substring(0, 4)
									+ "...");
							log4jParamters_tFileInputExcel_1.append(" | ");
				...
				final String decryptedPassword_tFileInputExcel_1 = routines.system.PasswordEncryptUtil
						.decryptPassword("enc:routine.encryption.key.v1:/QUqG9ESPm9LIPbLxGjOkPnwrnxrr0DtPY35Iw==");
...
// # Output table : 'out1'
									...
									out1_tmp.email = Var.vCleanName.length() < 7
											...
											: Var.vCleanName.length() == 7 ? Var.vCleanName.toLowerCase() + "@msn.com"
									...
									out1_tmp.ChurnDate = row12.DateChurn != null
											...
											: "Active";
									out1_tmp.TotalTransaction = row5.TotalTransaction == null ? 0
...
// Start of branch "out1"
								if (out1 != null) {
									...
									if (runStat.update(execStat, enableLogStash, iterateId, 1, 1
											...
											, "out1", "tMap_1", "tMap_1", "tMap", "tFileOutputDelimited_3",
									...
									if (out1.CustomerId != null) {
										sb_tFileOutputDelimited_3.append(out1.CustomerId);
									}
									...
									sb_tFileOutputDelimited_3.append(OUT_DELIM_tFileOutputDelimited_3);
									if (out1.HashCode != null) {
										sb_tFileOutputDelimited_3.append(out1.HashCode);
									}
									sb_tFileOutputDelimited_3.append(OUT_DELIM_tFileOutputDelimited_3);
									if (out1.gender != null) {
									...
									sb_tFileOutputDelimited_3.append(OUT_DELIM_tFileOutputDelimited_3);
									if (out1.email != null) {
										sb_tFileOutputDelimited_3.append(out1.email);
									}
									sb_tFileOutputDelimited_3.append(OUT_DELIM_tFileOutputDelimited_3);
									if (out1.Birthday != null) {
										sb_tFileOutputDelimited_3.append(out1.Birthday);
									}
									sb_tFileOutputDelimited_3.append(OUT_DELIM_tFileOutputDelimited_3);
									if (out1.Age != null) {
										sb_tFileOutputDelimited_3.append(out1.Age);
									}
									sb_tFileOutputDelimited_3.append(OUT_DELIM_tFileOutputDelimited_3);
									if (out1.PostalCode != null) {
										sb_tFileOutputDelimited_3.append(out1.PostalCode);
									}
									sb_tFileOutputDelimited_3.append(OUT_DELIM_tFileOutputDelimited_3);
									if (out1.State != null) {
										sb_tFileOutputDelimited_3.append(out1.State);
									}
									sb_tFileOutputDelimited_3.append(OUT_DELIM_tFileOutputDelimited_3);
									if (out1.UserStatus != null) {
										sb_tFileOutputDelimited_3.append(out1.UserStatus);
									}
									sb_tFileOutputDelimited_3.append(OUT_DELIM_tFileOutputDelimited_3);
									if (out1.ChurnDate != null) {
										sb_tFileOutputDelimited_3.append(out1.ChurnDate);
									}
									sb_tFileOutputDelimited_3.append(OUT_DELIM_tFileOutputDelimited_3);
									if (out1.TotalTransaction != null) {
										sb_tFileOutputDelimited_3.append(out1.TotalTransaction);
									}
...
///////////////////////		
									...
									if (row9.CustomerId != null) { //
										...
										strBuffer_tLogRow_1.append(String.valueOf(row9.CustomerId));
									...
									if (row9.Name != null) { //
										...
										strBuffer_tLogRow_1.append(String.valueOf(row9.Name));
									...
									if (row9.HashCode != null) { //
										...
										strBuffer_tLogRow_1.append(String.valueOf(row9.HashCode));
									...
									if (row9.gender != null) { //
										...
										strBuffer_tLogRow_1.append(String.valueOf(row9.gender));
									...
									if (row9.email != null) { //
										...
										strBuffer_tLogRow_1.append(String.valueOf(row9.email));
									...
									if (row9.Birthday != null) { //
										...
										strBuffer_tLogRow_1.append(String.valueOf(row9.Birthday));
									...
									if (row9.Age != null) { //
										...
										strBuffer_tLogRow_1.append(String.valueOf(row9.Age));
									...
									if (row9.PostalCode != null) { //
										...
										strBuffer_tLogRow_1.append(String.valueOf(row9.PostalCode));
									...
									if (row9.State != null) { //
										...
										strBuffer_tLogRow_1.append(String.valueOf(row9.State));
									...
									if (row9.UserStatus != null) { //
										...
										strBuffer_tLogRow_1.append(String.valueOf(row9.UserStatus));
									...
									if (row9.ChurnDate != null) { //
										...
										strBuffer_tLogRow_1.append(String.valueOf(row9.ChurnDate));

									} //

									strBuffer_tLogRow_1.append("|");

									if (row9.TotalTransaction != null) { //

										strBuffer_tLogRow_1.append(FormatterUtils.formatUnwithE(row9.TotalTransaction));
...
// Start of branch "NoGender"
								if (NoGender != null) {
									...
									if (runStat.update(execStat, enableLogStash, iterateId, 1, 1
											...
											, "NoGender", "tMap_1", "tMap_1", "tMap", "tFilterRow_14", "tFilterRow_1",
											"tFilterRow"
...
// Start of branch "row6"
									if (row6 != null) {
										...
										if (runStat.update(execStat, enableLogStash, iterateId, 1, 1
												...
												, "row6", "tFilterRow_14", "tFilterRow_1", "tFilterRow",
...
// Start of branch "NoState"
								if (NoState != null) {
									...
									if (runStat.update(execStat, enableLogStash, iterateId, 1, 1
											...
											, "NoState", "tMap_1", "tMap_1", "tMap", "tFilterRow_10", "tFilterRow_1",
											"tFilterRow"
...
// Start of branch "row8"
									if (row8 != null) {
										...
										if (runStat.update(execStat, enableLogStash, iterateId, 1, 1
												...
												, "row8", "tFilterRow_10", "tFilterRow_1", "tFilterRow",
...
// ###############################      
				...
				if (runStat.updateStatAndLog(execStat, enableLogStash, resourceMap, iterateId, "out1", 2, 0, "tMap_1",
						"tMap_1", "tMap", "tFileOutputDelimited_3", "tFileOutputDelimited_3", "tFileOutputDelimited",
						"output")) {
					talendJobLogProcess(globalMap);
				}
...
///////////////////////    			
				...
				if (runStat.updateStatAndLog(execStat, enableLogStash, resourceMap, iterateId, "NoGender", 2, 0,
						"tMap_1", "tMap_1", "tMap", "tFilterRow_14", "tFilterRow_1", "tFilterRow", "output")) {
					talendJobLogProcess(globalMap);
				}
				...
				if (runStat.updateStatAndLog(execStat, enableLogStash, resourceMap, iterateId, "row6", 2, 0,
						"tFilterRow_14", "tFilterRow_1", "tFilterRow", "tFileOutputDelimited_1",
				...
				if (runStat.updateStatAndLog(execStat, enableLogStash, resourceMap, iterateId, "NoState", 2, 0,
						"tMap_1", "tMap_1", "tMap", "tFilterRow_10", "tFilterRow_1", "tFilterRow", "output")) {
					talendJobLogProcess(globalMap);
				}
				...
				if (runStat.updateStatAndLog(execStat, enableLogStash, resourceMap, iterateId, "row8", 2, 0,
						"tFilterRow_10", "tFilterRow_1", "tFilterRow", "tFileOutputDelimited_2",
	...
	public static void main(String[] args) {
		final Copy_of_TelcoJob1 Copy_of_TelcoJob1Class = new Copy_of_TelcoJob1();

		int exitCode = Copy_of_TelcoJob1Class.runJobInTOS(args);
		if (exitCode == 0) {
			log.info("TalendJob: 'Copy_of_TelcoJob1' - Done.");
		}
	...
	public int runJobInTOS(String[] args) {
		...
		getjobInfo();
		log.info("TalendJob: 'Copy_of_TelcoJob1' - Start.");
		...
		org.slf4j.MDC.put("_jobRepositoryId", "_wmeusCmqEfGwbuACrNMKng");
		org.slf4j.MDC.put("_compiledAtTimestamp", "2026-03-30T01:56:24.234107Z");
		...
		try {
			...
			java.io.InputStream inContext = Copy_of_TelcoJob1.class.getClassLoader()
					.getResourceAsStream("telco/copy_of_telcojob1_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = Copy_of_TelcoJob1.class.getClassLoader()
		...
		log.info("TalendJob: 'Copy_of_TelcoJob1' - Started.");
		...
		if (false) {
			System.out.println(
					(endUsedMemory - startUsedMemory) + " bytes memory increase when running : Copy_of_TelcoJob1");
		}
		if (enableLogStash) {
		...
		log.info("TalendJob: 'Copy_of_TelcoJob1' - Finished - status: " + status + " returnCode: " + returnCode);
...
/************************************************************************************************
 * 385331 characters generated by Talend Cloud Data Management Platform on the
 * 30 March 2026 at 9:56:24 am MYT
 ************************************************************************************************/